...
\begin{document}
	...
	\begin{table}[h]
		...
		\begin{tabular}{llll}
			\textbf{Model name} & \textbf{All view angles} & \textbf{$90^\circ$ view angle} & \textbf{Parameters} \\ \hline
			Shape Index + 3D CNN    & 1.62\% & \textbf{\textendash} & $\approx 650.000$   \\ \hline
			3D CNN                  & 59\%   & 89\%                 & $\approx 650.000$   \\ \hline
			2D Deep CNN + LSTM      & 73.7\% & 80.6\%               & $\approx 5.100.000$ \\ \hline
			2D CNN + LSTM           & 74\%   & 83.8\%               & $\approx 250.000$   \\ \hline
			3D CNN + Dense(200)     & 91.7\% & 91.9\%               & $\approx 650.000$   \\
		\end{tabular}
	\end{table}
	...
	\begin{table}[h]
		...
		\begin{tabularx}{\textwidth}{
			...
			\textbf{Model name} & \textbf{All view angles} & \textbf{$90^\circ$ view angle}\\ \hline
			VGR-net \cite{VGR-Net}             & \textbf{\textendash} & 97.08\%\\ \hline
			MVCNN \cite{Wolf2016MultiviewGR}   & \textbf{\textendash} & 99.9\%\\ \hline
			NDM \cite{gait-with-curvature-map} & \textbf{\textendash} & 16.7\%\\ \hline
			GEI deep CNN \cite{gait-with-gei}  & \textbf{\textendash} & 98.3\%\\ \hline
			2D CNN + LSTM (ours)               & 74\%                 & 83.8\%\\ \hline
			3D CNN + Dense(200) (ours)         & 91.7\%               & 91.9\%\\
		\end{tabularx}
	\end{table}
